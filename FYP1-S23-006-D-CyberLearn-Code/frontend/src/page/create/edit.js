...
async function ConnectKali() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      await axios.post(`http://localhost:4000/courses/edit/${id}`, formData, {
      ...
      console.log(error);
      setError("Failed to update course. Try again!!!");
    }
  };

  const subTitle = "Edit Course";
  const title = "Update Your Course Content";
    ...
    const getCourseContent = async () => {
      try {
        ...
        const response = await fetch(
          `http://localhost:4000/courses/edit/${id}`
        );
                        ...
                        {lecture.isEditing ? (
                          <div className="form-group lecture-title-row">
                            ...
                            <button
                              ...
                              className="btn btn-secondary"
                              onClick={() =>
                                handleLectureAddClick(index, lectureIndex)
                              }
                            >
                              Add
                            </button>
                          ...
                          <div className="lecture-title-row">
                            ...
                            <button
                              ...
                              <button
                                ...
                                className="btn btn-secondary"
                                onClick={() =>
                                  handleTextEditorClick(index, lectureIndex)
                                }
                              >
                                Text Editor
                              </button>
                              ...
                              <button
                                ...
                                className="btn btn-secondary"
                                onClick={() =>
                                  handleLectureEditClick(index, lectureIndex)
                                }
                              >
                                Edit
                              </button>
                              <button
                                ...
                                className="btn btn-danger"
                                onClick={() =>
                                  handleLectureDeleteClick(index, lectureIndex)
                                }
                              >
                                Delete
                              </button>
